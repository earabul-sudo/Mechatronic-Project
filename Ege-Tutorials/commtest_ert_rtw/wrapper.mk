...
MAKE_PATH = D:/Program Files (x86)/bin/win64
...
MODELMK=commtest.mk
SLIB_PATH=C:/Users/Ege/DOCUME~1/MATLAB/R2020b/ARDUIN~1/ARDUIN~1/FASTER~1
VARIANT_HEADER_PATH=$(ARDUINO_SAMD_ROOT)/hardware/samd/1.8.4/variants/nano_33_iot
...
all : 
	...
	"$(MAKE)" -j7 -C "$(SLMKPATH)" SHELL="$(SHELL)" -f wifinina.mk all
	"$(MAKE)" -j7 -C "$(SLMKPATH)" SHELL="$(SHELL)" -f samdcomm.mk all
	"$(MAKE)" -j7 -C "$(SLMKPATH)" SHELL="$(SHELL)" -f samdcore.mk all
