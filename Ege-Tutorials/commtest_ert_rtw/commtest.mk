###########################################################################
## Makefile generated for component 'commtest'. 
## 
## Makefile     : commtest.mk
## Generated on : Sat Oct 31 15:45:28 2020
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/commtest.elf
...
SLIB_PATH                   = C:/Users/Ege/DOCUME~1/MATLAB/R2020b/ARDUIN~1/ARDUIN~1/FASTER~1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/commtest.elf
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -D_MW_ARDUINO_LOOP_=1 -DMW_ARDUINO_STEP_SIZE=100000 -DMW_ARDUINO_MICROS -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_BAUDRATE_SERIAL1_=9600 -D_RTT_ANALOG_REF_=0 -D_RTT_WIFI_TCP_=1 -D_RTT_WIFI_TCP_SERVER_PORT_ORDERED=25000 -D_RTT_WIFI_TCP_SERVER_=1 -D_RTT_WIFI_Local_IP1=192 -D_RTT_WIFI_Local_IP2=168 -D_RTT_WIFI_Local_IP3=1 -D_RTT_WIFI_Local_IP4=134 -D_RTT_WIFI_SSID="BT-KNA3KS" -D_RTT_WIFI_WPA_PASSWORD="6vJua4qFT3EugT" -D_RTT_WIFI_WPA=1 -D_RTT_DISABLE_Wifi_DHCP_=1
...
DEFINES_STANDARD = -DMODEL=commtest -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_WiFiTCP.o commtest.o updown.o ext_work.o rtiostream_utils.o MW_ArduinoHWInit.o io_wrappers.o arduinoARM_M0plusScheduler.o m0m1m0plus_multitasking.o rtiostream_interface.o ext_svr_daemon.o rtiostream_serial_daemon.o daemon_checksum.o
...
%.o : $(START_DIR)/commtest_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/commtest_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/commtest_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/commtest_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/commtest_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
commtest.o : $(START_DIR)/commtest_ert_rtw/commtest.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/commtest_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
