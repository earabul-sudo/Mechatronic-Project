###########################################################################
## Makefile generated for component 'physicalmotortest'. 
## 
## Makefile     : physicalmotortest.mk
## Generated on : Sun Nov 08 13:32:32 2020
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/physicalmotortest.elf
...
PRODUCT_NAME              = physicalmotortest
MAKEFILE                  = physicalmotortest.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/physicalmotortest.elf
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DMW_TIMERID=10 -DMW_PRESCALAR=512 -DMW_TIMERCOUNT=3125 -DMW_SCHEDULERCOUNTER=1 -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_BAUDRATE_SERIAL1_=9600 -D_RTT_ANALOG_REF_=0
...
DEFINES_STANDARD = -DMODEL=physicalmotortest -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_PWM.o MW_PWMDriver.o ArduinoPinHandleMap.o xcp_ext_work.o physicalmotortest.o physicalmotortest_data.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_frame_serial.o xcp_ext_param_default_serial.o MW_ArduinoHWInit.o io_wrappers.o arduinoARM_M0plusScheduler.o m0m1m0plus_multitasking.o rtiostream_serial_daemon.o sys_arch.o
...
%.o : $(START_DIR)/physicalmotortest_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/physicalmotortest_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/physicalmotortest_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/physicalmotortest_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/physicalmotortest_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/physicalmotortest_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


physicalmotortest.o : $(START_DIR)/physicalmotortest_ert_rtw/physicalmotortest.c
	$(CC) $(CFLAGS) -o "$@" "$<"


physicalmotortest_data.o : $(START_DIR)/physicalmotortest_ert_rtw/physicalmotortest_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
